...
from .spoofer.search_faults import broken_tavily_search, limited_tavily_search
...
def tavily_wrapper(version, *args, **kwargs):
    return _REGISTRY[version](*args, **kwargs)

def register(version):
    def decorator(func):
            _REGISTRY[version] = func
            return func
    return decorator
...
register("broken")(broken_tavily_search)
register("limited")(limited_tavily_search)
